...
export function PageHero({
  ...
  return (
    <section className="relative isolate overflow-hidden border-b border-border" style={{ minHeight: height }}>
      {image && (
      ...
      <div className="container-site relative z-10 pt-24 pb-12 md:pt-32 md:pb-16">
